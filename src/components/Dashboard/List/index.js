...
function List({ coin }) {
   ...
   <Tooltip title="Coin Percentage Change">
            ...
            {coin.price_change_percentage_24h > 0 ? (<td className="chip-flex">
                ...
                <div className="icon-chip td-icon"><TrendingUpRoundedIcon />
                </div>
            </td>) : (<td className="chip-flex">
                <div className="price-chip chip-red ">{coin.price_change_percentage_24h.toFixed(2)
                }%
                </div>
                <div className="icon-chip chip-red td-icon"><TrendingDownRoundedIcon />
                </div>
            </td>)}
            </Tooltip >
            ...
            <Tooltip title="Market Cap" placement="bottom-end">
                ...
                <p className="total-volume td-right-align">${convertNumbers(coin.market_cap)}</p>
            </td>
